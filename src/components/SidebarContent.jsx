      ...
      <nav className="space-y-4">
        ...
        <div className="pt-6 mt-6 border-t border-gray-200 dark:border-gray-700">
          <button
            ...
            className="flex items-center px-4 py-3 rounded-lg text-gray-700 dark:text-gray-200 hover:text-gray-800 hover:bg-gray-100 dark:bg-gray-700 transition w-full"
          >
            <svg
              className="w-5 h-5 mr-3"
              fill="none"
